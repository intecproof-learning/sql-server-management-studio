...
namespace LoadTest_SQLServer
{
    ...
    public partial class AdventureWorksEntities2 : DbContext
    {
        public AdventureWorksEntities2()
            : base("name=AdventureWorksEntities2")
        {
        }
        ...
        public virtual DbSet<DeleteOperations> DeleteOperations { get; set; }
        public virtual DbSet<DepartmentBackup> DepartmentBackup { get; set; }
        public virtual DbSet<EmployeeDepartmentHistoryBackup> EmployeeDepartmentHistoryBackup { get; set; }
        public virtual DbSet<Errores> Errores { get; set; }
        public virtual DbSet<ProductDocument> ProductDocument { get; set; }
    
        public virtual ObjectResult<usp_GetProductVendors_LoadTest_Result> usp_GetProductVendors_LoadTest(Nullable<int> productID)
        {
            var productIDParameter = productID.HasValue ?
                new ObjectParameter("productID", productID) :
                new ObjectParameter("productID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_GetProductVendors_LoadTest_Result>("usp_GetProductVendors_LoadTest", productIDParameter);
        }
    
        public virtual ObjectResult<usp_GetSalesByClientReport_LoadTest_Result> usp_GetSalesByClientReport_LoadTest(Nullable<int> personID)
        {
            var personIDParameter = personID.HasValue ?
                new ObjectParameter("personID", personID) :
                new ObjectParameter("personID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_GetSalesByClientReport_LoadTest_Result>("usp_GetSalesByClientReport_LoadTest", personIDParameter);
        }
    }
}
